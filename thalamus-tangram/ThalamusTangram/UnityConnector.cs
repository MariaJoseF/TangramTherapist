...
{ 
    public class UnityConnector
    {
        ...
        public ITUnityCallerRpc RPCProxy { private set; get; }
        private int _remotePort = 7001;
        private string _remoteAddress = "localhost";//"192.168.1.128"; //
        private ThalamusConnector _thalamusClient;

        public UnityConnector(ThalamusConnector thalamusClient)
        {
            ...
            RPCProxy = XmlRpcProxyGen.Create<ITUnityCallerRpc>();
